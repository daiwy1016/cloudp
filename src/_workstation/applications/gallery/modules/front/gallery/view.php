...
class _view extends \IPS\Content\Controller
{
	...
	protected function download()
	{
		...
		{
			/* Get file and data */
			$file		= \IPS\File::get( 'gallery_Images', $this->image->original_file_name ?: $this->image->masked_file_name );
	...
	protected function move()
	{
		try
		{
			...
			$form = \IPS\gallery\Image\Table::buildMoveForm( $item->container(), 'IPS\\gallery\\Image', array( 'forceOwner' => $item->author() ) );
