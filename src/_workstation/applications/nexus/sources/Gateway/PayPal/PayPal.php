...
class _PayPal extends \IPS\nexus\Gateway
{
	...
	{		
		...
		{
			/* Supported Currencies via https://developer.paypal.com/docs/integration/direct/rest/currency-codes/ */
			if ( !\in_array( $amount->currency, array( 'AUD', 'USD', 'CZK', 'DKK', 'HKD', 'ILS', 'CAD', 'EUR', 'MXN', 'NZD', 'NOK', 'PHP', 'PLN', 'JPY', 'GBP', 'RUB', 'SGD', 'SEK', 'CHF', 'THB' ) ) or !$customer->cm_first_name or !$customer->cm_last_name or !$billingAddress )
			{
				return FALSE;
			}
		}
