...
class _Phpbb extends \IPS\convert\Software
{
	...
	{
		if( isset( $rows['convertBanfilters'] ) )
		{
			$rows['convertBanfilters2'] = $rows['convertBanfilters'];
			$rows['convertBanfilters2']['step_method'] = 'convertBanfilters2';
			$rows['convertBanfilters2']['source_rows'] = array( 'table' => static::canConvert()['convertBanfilters2']['table'], 'where' => static::canConvert()['convertBanfilters2']['where'] );
		}
