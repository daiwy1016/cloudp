...
class _Expressionengine extends \IPS\convert\Software
{
	...
	{
		$rows['convertOtherPosts'] = $rows['convertForumsPosts'];
		$rows['convertOtherPosts']['step_method'] = 'convertOtherPosts';
		$rows['convertOtherPosts']['source_rows'] = array( 'table' => static::canConvert()['convertOtherPosts']['table'], 'where' => static::canConvert()['convertOtherPosts']['where'] );
