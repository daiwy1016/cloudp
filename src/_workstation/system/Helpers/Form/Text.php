...
class _Text extends TextArea
{
	...
	public function validate()
	{
		...
		/* Split on profanity */
		if( $this->options['bypassProfanity'] === FALSE and is_string( $this->value ) and \IPS\Dispatcher::i() instanceof \IPS\Dispatcher\Front and !\IPS\Member::loggedIn()->group['g_bypass_badwords'] AND !$this->options['accountUsername'] )
		{
			$newVal = NULL;
