        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    <?php echo e(Lang::get('messages.admin.settings.menu')); ?>

                </h3>
                <div class="box-tools">
                    <a class="btn btn-primary btn-sm"
                       href="<?php echo e(route('admin.settings.menu.create')); ?>">
                        <i class="fa fa-plus"></i> <?php echo e(Lang::get('messages.admin.settings.create')); ?>
