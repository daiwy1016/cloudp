    ...
    <div class="col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                <i class="fa fa-pencil-square-o"></i> <?php echo e(Lang::get('messages.admin.dashboard.create-manga')); ?>

            </div>
            <!-- /.panel-heading -->
            <?php echo e(Form::open(array('route' => 'admin.manga.store', 'role' => 'form'))); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('slug','', array('class' => 'form-control', 'placeholder' => Lang::get('messages.admin.manga.create.slug-placeholder')))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('otherNames', '', array('class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('author', '', array('class' => 'authors'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('artist', '', array('class' => 'authors'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('releaseDate', '', array('class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('status_id', $status, '', array('class' => 'status selectpicker', 'data-width' => '100%'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('categories[]', $categories, '', array('class' => 'categorie selectpicker', 'multiple', 'title' => Lang::get('messages.admin.manga.create.categories-title'), 'data-selected-text-format' => 'count>7', 'data-width' => '100%'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('tags', '', array('class' => 'tags'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('type_id', $comicTypes, '', array('class' => 'status selectpicker', 'data-width' => '100%'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('summary', '', array('class' => 'form-control', 'rows' => '5'))); ?>
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="caution" value="1" /><?php echo e(Lang::get('messages.admin.users.options.yes')); ?>

                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="caution" value="0" checked="checked" /><?php echo e(Lang::get('messages.admin.users.options.no')); ?>
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    <?php echo e(Form::submit(Lang::get('messages.admin.manga.create-manga'), array('class' => 'btn btn-primary btn-xs'))); ?>
...
<script>
    ...
    $('#get-data').click(function () {
        if ($.trim($('#url-data').val()).length > 0) {
            $.ajax({
                url: "<?php echo e(route('admin.manga.autoMangaInfo')); ?>",
                method: 'POST',
                data: {
